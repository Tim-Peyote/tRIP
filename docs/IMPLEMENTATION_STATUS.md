...
2. Построить корневой колодец как третью вертикальную экспедицию по выбранному плану.
3. Расширить физический гербарий отдельными карточками изученных видов и образцов.
