...
1. Rigged first-person hands и отдельные анимации среза, измельчения, розлива и осмотра.
2. Добавить безопасные карманы и скрытый след внутри рощи, чтобы прилив создавал маршрутное решение.
3. Сделать гербарную стену и доску гипотез физическими интерфейсами убежища.
4. Ввести рецепт усиленного спорозрения с необратимым world-state последствием.
