...
5. Terrain/LOD/occlusion pass после профилирования нового плотного dressing.
...
- Добавлен `BiomeDressingScatter`: один модуль строит отдельные MultiMesh-пулы хвойных, широколиственных, сухих стволов, камней, валежника, холмов и дальних скальных масс.
