...
1. Превратить глубокую рощу в полноценную вторую экспедицию: вертикальный рельеф, развилки, новый гриб и первая встреча со следом самого миколога.
2. Rigged first-person hands и отдельные анимации среза, измельчения, розлива и осмотра.
3. Surface footsteps, creature vocal layers и выразительные animation/audio cues состояний Listener.
4. Расширить убежище: спальное место, гербарная стена, доска гипотез, кладовая и визуальное развитие после циклов.
5. Terrain authoring/LOD/occlusion pass после профилирования объединённого лесного маршрута.
