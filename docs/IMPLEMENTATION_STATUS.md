...
1. Создать рецепт-контрагент из тлеющей ягоды и третью развилку: подавить спорозрение или усилить его ценой слуха.
2. Rigged first-person hands и отдельные анимации среза, измельчения, розлива и осмотра.
3. Добавить в глубокую рощу новую системную угрозу и состояние спорового прилива.
4. Сделать гербарную стену и доску гипотез физическими интерфейсами убежища.
